  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="item in addressInfo" :key="item.id">
        ...
        <p @click="change(item, addressInfo)">
...
export default {
  ...
  mounted() {
    ...
    // this.addressInfo[1].isDefault = 1
  },
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      let data = {
        consignee: this.userDefaultAddress.consignee, //用户名字
        consigneeTel: this.userDefaultAddress.phoneNum,  //电话
        deliveryAddress: this.userDefaultAddress.fullAddress, //地址
        paymentWay: "ONLINE",  //支付方式
        orderComment: this.msg, //备注
        orderDetailList: this.orderInfo.detailArrayList //产品的信息
      }; 
